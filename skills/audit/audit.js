...
function preAuditCarryForward(pre) {
  ...
  return {
    ...
    website_tracking: {
      meta_pixel_on_site: pa.website?.meta_pixel?.installed ?? null,
      meta_pixel_id_on_site: pa.website?.meta_pixel?.id ?? null,
      conversion_events_on_site: pa.website?.conversion_events ?? null,
      ga4: pa.website?.ga4?.installed ?? null,
      ga4_id: pa.website?.ga4?.id ?? null,
      google_tag: pa.website?.gtm?.installed ?? null,
      google_tag_id: pa.website?.gtm?.id ?? null,
      mobile_responsive: pa.website?.viewport_meta ?? null,
    },
