...
<footer class="ds-footer">Prepared by smOS · ${date}. Baseline scope: ${paid.skipped || (paid.total_spend_lifetime ?? 0) === 0 ? "organic + account-readiness (no paid spend history)" : "full organic + paid"}. Immutable baseline for future before/after comparisons.</footer>
</div></body></html>`;
}
