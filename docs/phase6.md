...
**Status:** 🔲 Not started  
**Depends on:** Phase 5 complete (optimization loop running, at least 2 weeks of data)  
...
**Outputs:** `weekly_report.md` + PDF → Google Drive → Slack + email
...
4. Generate PDF
5. Upload to client Google Drive folder
6. Send to Slack client channel with summary stats
7. Send via Gmail to client contact from profile
8. Update `reports` table in Supabase
...
- Weekly report generated, sent to Slack, uploaded to Drive
- Reporter agent runs on Monday schedule without human trigger
...
| Phase 2 — Intake & Audit | 2–3 | — | 🔲 |
| Phase 3 — Research & Strategy | 2 | — | 🔲 |
| Phase 4 — Creative & Launch | 2–3 | — | 🔲 |
| Phase 5 — Optimization Loop | 2–3 | — | 🔲 |
| Phase 6 — Reporting & Polish | 2–3 | — | 🔲 |
| **Total** | **12–17 days** | | |
